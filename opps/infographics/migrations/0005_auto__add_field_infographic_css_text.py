...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'InfographicConfig', fields ['date_available']
        db.create_index(u'infographics_infographicconfig', ['date_available'])

        # Adding index on 'InfographicConfig', fields ['published']
        db.create_index(u'infographics_infographicconfig', ['published'])

        # Adding field 'Infographic.css_text'
        db.add_column(u'infographics_infographic', 'css_text',
        ...
        # Adding index on 'Infographic', fields ['date_available']
        db.create_index(u'infographics_infographic', ['date_available'])

        # Adding index on 'Infographic', fields ['published']
        db.create_index(u'infographics_infographic', ['published'])

        # Adding index on 'InfographicBox', fields ['date_available']
        db.create_index(u'infographics_infographicbox', ['date_available'])

        # Adding index on 'InfographicBox', fields ['published']
        db.create_index(u'infographics_infographicbox', ['published'])


    def backwards(self, orm):
        # Removing index on 'InfographicBox', fields ['published']
        db.delete_index(u'infographics_infographicbox', ['published'])

        # Removing index on 'InfographicBox', fields ['date_available']
        db.delete_index(u'infographics_infographicbox', ['date_available'])

        # Removing index on 'Infographic', fields ['published']
        db.delete_index(u'infographics_infographic', ['published'])

        # Removing index on 'Infographic', fields ['date_available']
        db.delete_index(u'infographics_infographic', ['date_available'])

        # Removing index on 'InfographicConfig', fields ['published']
        db.delete_index(u'infographics_infographicconfig', ['published'])

        # Removing index on 'InfographicConfig', fields ['date_available']
        db.delete_index(u'infographics_infographicconfig', ['date_available'])

        # Deleting field 'Infographic.css_text'
        db.delete_column(u'infographics_infographic', 'css_text')
