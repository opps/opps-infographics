...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Infographic', fields ['slug']
        db.delete_unique(u'infographics_infographic', ['slug'])

        # Adding field 'InfographicBoxInfographics.date_available'
        db.add_column(u'infographics_infographicboxinfographics', 'date_available',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True),
                      keep_default=False)

        # Adding field 'InfographicBoxInfographics.date_end'
        db.add_column(u'infographics_infographicboxinfographics', 'date_end',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding unique constraint on 'Infographic', fields ['slug']
        db.create_unique(u'infographics_infographic', ['slug'])

        # Deleting field 'InfographicBoxInfographics.date_available'
        db.delete_column(u'infographics_infographicboxinfographics', 'date_available')

        # Deleting field 'InfographicBoxInfographics.date_end'
        db.delete_column(u'infographics_infographicboxinfographics', 'date_end')
